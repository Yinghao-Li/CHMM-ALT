...
@dataclass
class CHMMConfig(CHMMArguments, NERConfig):
    """
    ...
    def save(self, file_dir: str, file_name: Optional[str] = 'chmm-config') -> "NERConfig":
        super().save(file_dir, file_name)
        return self

    def load(self, file_dir: str, file_name: Optional[str] = 'chmm-config') -> "NERConfig":
