...
class DirCHMMArguments:
    ...
    use_dirichlet_emiss: Optional[bool] = field(
        default=False, metadata={'help': 'Sample emission from nn-parameterized dirichlet.'}
    )
...
@dataclass
class DirCHMMConfig(DirCHMMArguments, CHMMConfig):
    pass
