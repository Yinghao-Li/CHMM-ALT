...
from label_model.prior_chmm.train import PriorTrainer
from label_model.prior_chmm.args import Arguments, PriorConfig
...
def chmm_train(args: Arguments):
    ...
    result_file = os.path.join(args.output_dir, 'prior-chmm-results.txt')
