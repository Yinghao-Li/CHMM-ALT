...
TRAIN_FILE="../../data/BC5CDR/BC5CDR-linked-train.pt"
VALID_FILE="../../data/BC5CDR/BC5CDR-linked-dev.pt"
TEST_FILE="../../data/BC5CDR/BC5CDR-linked-test.pt"
OUTPUT_DIR="./output/bc5cdr-chmm-oe-0/"
# OUTPUT_DIR="./output/bc5cdr-chmm-ne-0/"  
